...
Ogni lezione dura 15-30 minuti. Le ore includono lettura, codice, quiz e —
dove c'e' — l'esercizio; sono stime da validare con learner review.
...
corso), poi esempi eseguibili, e infine un quiz con le risposte.

Le **lezioni 1-30** aggiungono un esercizio guidato con la soluzione spiegata
subito sotto, e **il passo del progetto**: un'unica applicazione (il Memory
AI Lab) che cresce di un componente a ogni lezione. Le **lezioni 31-60** sono
di sola lettura: niente esercizio guidato, il codice e' gia' scritto e
commentato. Le **lezioni 52-60** sono il capstone, cioe' il progetto stesso
portato a sistema completo.

Le pagine di questo sito sono i riassunti di riferimento.
